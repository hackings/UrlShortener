...
module V1
  describe 'v1/short_urls/show', type: :view do

    describe 'v1/short_urls/show.json.rabl' do
      it 'renders short_url hash' do
        @short_url = FactoryGirl.create(:v1_short_url) 
        render template: 'v1/short_urls/show.json.rabl', format: :json
        ...
        expect( view.has_key?(:count) ).to eq true        
      end
